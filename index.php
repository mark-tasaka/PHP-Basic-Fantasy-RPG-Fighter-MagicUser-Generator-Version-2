...
<html>
<head>
<title>Launch Page: Fighter/Magic-User Character Generator Basic Fantasy RPG</title>
...
<body>
	...
	<section>
		...
		<h1><img src="launchPage/images/title.png" alt="FighterMagic Character Generator Basic Fantasy RPG" class="image" /></h1>
		...
		<form action="" id ="FighterMagicFormV3"  target="_blank" method="post">
...
<select id="level" name="theLevelV2" class="alignmentBox">	
				<option value="1" selected>1st Level, Fighter/Magic-User</option>
				<option value="2">2nd Level, Fighter/Magic-User</option>
				<option value="3">3rd Level, Fighter/Magic-User</option>
				<option value="4">4th Level, Fighter/Magic-User</option>
				<option value="5">5th Level, Fighter/Magic-User</option>
				<option value="6">6th Level, Fighter/Magic-User</option>
				<option value="7">7th Level, Fighter/Magic-User</option>
				<option value="8">8th Level, Fighter/Magic-User</option>
				<option value="9">9th Level, Fighter/Magic-User</option>
				<option value="10">10th Level, Fighter/Magic-User</option>
				<option value="11">11th Level, Fighter/Magic-User</option>
				<option value="12">12th Level, Fighter/Magic-User</option>
				<option value="13">13th Level, Fighter/Magic-User</option>
				<option value="14">14th Level, Fighter/Magic-User</option>
				<option value="15">15th Level, Fighter/Magic-User</option>
				<option value="16">16th Level, Fighter/Magic-User</option>
				<option value="17">17th Level, Fighter/Magic-User</option>
				<option value="18">18th Level, Fighter/Magic-User</option>
				<option value="19">19th Level, Fighter/Magic-User</option>
				<option value="20">20th Level, Fighter/Magic-User</option>
</select>
...
<option value="1" selected>Leather Armour</option>
...
<option value="1" selected>Add Shield</option>
</select>
...
<option value="5">5d10 gp, 5d10 pp&#42;</option>
  ...
  <span class="weaponSubHead">Axes:</span><br/>
  <input type="checkbox" name="theWeaponsV2[]" value="0"> Hand Axe<br/>
      <input type="checkbox" name="theWeaponsV2[]" value="1"> Battle Axe<br/>  
      <input type="checkbox" name="theWeaponsV2[]" value="2"> Great Axe<br/>  
      <span class="weaponSubHead">Bows:</span><br/>
      <input type="checkbox" name="theWeaponsV2[]" value="3"> Shortbow<br/>  
      <input type="checkbox" name="theWeaponsV2[]" value="4"> Longbow<br/> 
      <input type="checkbox" name="theWeaponsV2[]" value="5"> Light Crossbow<br/>   
      <input type="checkbox" name="theWeaponsV2[]" value="6"> Heavy Crossbow<br/> 
      ...
      <input type="checkbox" name="theWeaponsV2[]" value="9"> Shortsword<br/> 
      <input type="checkbox" name="theWeaponsV2[]" value="10"> Longsword/Scimitar<br/> 
      <input type="checkbox" name="theWeaponsV2[]" value="11"> Two-handed Sword<br/> 
      ...
      <input type="checkbox" name="theWeaponsV2[]" value="17"> Pole Arm<br/> 
      <input type="checkbox" name="theWeaponsV2[]" value="18"> Sling<br/> 
      <input type="checkbox" name="theWeaponsV2[]" value="19"> Spear<br/> 
		...
		<div class="content8">
            ...
            <br/>
                ...
                <script>
                   ...
                   $("#FighterMagicFormV3").attr('action', "character2/basicFighterMagic.php");
